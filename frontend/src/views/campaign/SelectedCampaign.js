    ...
    axios
      ...
      .then((response) => {
        ...
        const confirmed = response.data.filter(
          (freelancer) => freelancer.confirmed === true,
        );
        const unconfirmed = response.data.filter(
          (freelancer) => freelancer.confirmed === false,
        );
            ...
            <Box sx={{ marginTop: "15px" }}>
                ...
                <DialogContent>
                  {unconfirmedfreelancers.length > 0 ? (
                    ...
                    <Typography variant="body1">
                      No unconfirmed freelancers added.
                    </Typography>
                  )}
                </DialogContent>
              </Dialog>
              ...
              <Box sx={{ marginTop: "15px", marginX: "15px" }}>
                {confirmedfreelancers.length > 0 ? (
                  ...
                  <Typography variant="body1">
                    No confirmed freelancers added.
                  </Typography>
                )}
              </Box>
            </Box>
