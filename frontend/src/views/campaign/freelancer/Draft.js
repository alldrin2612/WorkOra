...
function Draft() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const secondResponse = await axios.post(
        `https://influverse-backend.onrender.com/api/interface-influence/${user.freelancer[0].slug}/campaign-work/campaign/${id}/`,
        {
          video: videoUrl,
          comments: comment,
        },
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://influverse-backend.onrender.com/api/interface-influence/freelancer/${user.freelancer[0].id}/freelancer-campaign-work/${id}/`,
      )
      .then((response) => {
            ...
            <Box sx={{ marginY: "10px" }}>
              ...
              {responseData && responseData.comments ? (
                <CommentsCard
                  ...
                  name={responseData.freelancer.name}
                  image={responseData.freelancer.image}
                />
              ) : (
                <Typography>
                  No comment by {responseData?.freelancer?.name}
                </Typography>
              )}
              ...
              {comment ? (
                <CommentsCard
                  comment={comment}
                  name={user.freelancer[0].name}
                  image={user.freelancer[0].image}
                />
