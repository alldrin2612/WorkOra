...
export default function GiftedfreelancerList() {
  return (
    <Box>
      <Box sx={{paddingBottom:"20px", display:"flex", justifyContent:"space-between", alignItems:"center"}}>
        ...
        <Button variant="contained" component={NavLink} to="/business/gifting/explore"  sx={{backgroundColor:"#252526", marginRight:"10px"}} endIcon={<CardGiftcardIcon />}>Send Gift</Button>
        <Button variant="contained" component={NavLink} to="/business/gifting/productlist" sx={{backgroundColor:"#252526"}} endIcon={<InventoryIcon />}>Product List</Button>
        </Box>
