...
// const user = JSON.parse(localStorage.getItem("user"));
  const [formData, setFormData] = useState({
    name: users.freelancer[0].name,
    email:users.freelancer[0].email,
    image:users.freelancer[0].image,
    crn: users.freelancer[0].crn,
    industry: users.freelancer[0].industry,
    address: users.freelancer[0].address,
    country: users.freelancer[0].country,
    pincode: users.freelancer[0].pincode,
    description: users.freelancer[0].description,
    phone:users.freelancer[0].phone,
    numberOfEmployees: '',
    annual_revenue: users.freelancer[0].annual_revenue,
    facebook: users.freelancer[0].facebook,
    instagram: users.freelancer[0].instagram,
    website: users.freelancer[0].website
  });
  ...
  if (user) {
    ...
    try {
      ...
      const response = await fetch(`https://influverse-backend.onrender.com/api/interface-influence/freelancer/${user.freelancer[0].id}`, {
        method: 'PATCH',
