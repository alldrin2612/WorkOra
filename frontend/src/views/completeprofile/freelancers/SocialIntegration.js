...
export default function SocialIntegration() {
    ...
    const handleInstagramLogin = () => {
      ...
      const redirectUri = encodeURIComponent('https://influverse-backend.onrender.com/api/interface-influence/freelancer/insta/'); // Replace with your actual redirect URL
