...
function EventRequest({ freelancerName, userName, slug, event, freelancerId , reloadfreelancers}) {
  ...
  const handleAccept = async () => {
    try {
      const response = await fetch(`https://influverse-backend.onrender.com/api/interface-buisness/${slug}/events/status-info/${event}/${freelancerId}/`, {
        method: 'POST',
        headers: {
