...
export default function SelectedEvent() {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://influverse-backend.onrender.com/api/interface-freelancer/${user.freelancer[0].slug}/events/${id}`,
      )
      .then((response) => {
        ...
        <Box>
          ...
          >
            ...
            <Box sx={{ display: "flex", justifyContent: "space-between" }}>
              ...
              <IconButton component={NavLink} to={`/view/event/edit-event/${id}`} aria-label="delete" size="large" sx={{"&:hover":{backgroundColor:'#252526', color:"white"}}}>
