...
const ProfileSection = () => {
  ...
  // const name = storedUser?.business ? storedUser.business[0].name : storedUser?.freelancer ? storedUser.freelancer[0].name : 'Guest';
  // const avatar = storedUser?.business ? storedUser.business[0].image : storedUser?.freelancer ? storedUser.freelancer[0].image : User1;
  // const type =storedUser?.business ? "Business" : storedUser?.freelancer ? "freelancer" : 'Guest';
  ...
  // Extracting values from the dummy freelancer data
  // const name = storedUser.freelancer ? storedUser.freelancer[0].name : 'Guest';
  // const avatar = storedUser.freelancer ? storedUser.freelancer[0].image : User1;
  // const type = "freelancer";

  const storedUser = JSON.parse(localStorage.getItem('user'));

// Extract values with default fallbacks
  const type = storedUser?.role || 'Guest';
  const name = storedUser?.name || 'Guest'; 
  const avatar = storedUser?.image || User1; 
