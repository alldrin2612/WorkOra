...
function LandingPage(props) {
  ...
  const drawer = (
    <Box onClick={handleDrawerToggle} sx={{ textAlign: 'center' , backgroundColor : "#252526"}}>
<Typography variant="h6" sx={{ my: 2 , color : "white", fontSize : 18}}>
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection:'column' }}>
      <CssBaseline />
      <AppBar component="nav" sx = {{ backgroundColor : '#252526'}}>
        <Toolbar>
          <IconButton
            color="inherit"
          ...
          <Box component={NavLink} to="/" sx={{ flexGrow: 1, display: { xs: 'none', sm: 'block' }, fontSize : 24, color : "White", textDecoration : "none" }}>
  <img src={Logo} alt="Logo" style={{ height: '40px' }} />
</Box>
      ...
      <Box component="main" sx={{ p: 3,  width:1, backgroundColor:"#252526"}}>
        <Toolbar />
        <Outlet/>
      </Box>
      <Footer/>
